...
class Teknikkomputer_model extends CI_Model {
    ...
    public function getDataSoal($id)
    {
        ...
        $this->datatables->from('teknikkomputer a');
    ...
    {
        return $this->db->get_where('teknikkomputer', ['id_soal' => $id])->row();
    }
