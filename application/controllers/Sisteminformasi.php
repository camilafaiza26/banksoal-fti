...
class Sisteminformasi extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('Sisteminformasi_model', 'soal');
    ...
    public function detail($id)
    {
        ...
        $this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('sisteminformasi/detail');
		$this->load->view('_templates/dashboard/_footer.php');
    }
    ...
    public function add()
	{
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('sisteminformasi/add');
		$this->load->view('_templates/dashboard/_footer.php');
    }
    ...
    public function edit($id)
	{
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('sisteminformasi/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}
    ...
    public function save()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            if($method==='add'){
                ...
                //insert data
                $this->master->create('sisteminformasi', $data);
            }else if($method==='edit'){
                //push array
                $data['updated_on'] = time();
                //update data
                $id_soal = $this->input->post('id_soal', true);
                $this->master->update('sisteminformasi', $data, 'id_soal', $id_soal);
            }else{
