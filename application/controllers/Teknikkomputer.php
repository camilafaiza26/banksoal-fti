...
class Teknikkomputer extends CI_Controller {
	...
	public function __construct(){
		...
		$this->load->model('Teknikkomputer_model', 'soal');
    ...
    public function index()
	{
		...
		$data = [
			'user' => $user,
			'judul'	=> 'Soal',
			'subjudul'=> 'Bank Latihan Soal'
        ];
        
        $data['matkul'] = $this->soal->getAllMatkul();

		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('teknikkomputer/data');
    ...
    public function detail($id)
    {
        ...
        $this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('teknikkomputer/detail');
		$this->load->view('_templates/dashboard/_footer.php');
    }
    ...
    public function add()
	{
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('teknikkomputer/add');
		$this->load->view('_templates/dashboard/_footer.php');
    }
    ...
    public function edit($id)
	{
		...
		$this->load->view('_templates/dashboard/_header.php', $data);
		$this->load->view('teknikkomputer/edit');
		$this->load->view('_templates/dashboard/_footer.php');
	}
    ...
    public function validasi()
    {
        ...
        $this->form_validation->set_rules('tahun', 'Tahun Soal', 'required|max_length[4]');
    ...
    public function save()
    {
        ...
        if($this->form_validation->run() === FALSE){
            ...
            if($method==='add'){
                ...
                //insert data
                $this->master->create('teknikkomputer', $data);
            }else if($method==='edit'){
                //push array
                $data['updated_on'] = time();
                //update data
                $id_soal = $this->input->post('id_soal', true);
                $this->master->update('teknikkomputer', $data, 'id_soal', $id_soal);
            }else{
                show_error('Method tidak diketahui', 404);
            }
            redirect('teknikkomputer');
        }
    }
