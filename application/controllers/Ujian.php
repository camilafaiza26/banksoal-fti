...
class Ujian extends CI_Controller {
    ...
    public function master()
	{
        ...
        $data = [
			'user' => $user,
			'judul'	=> 'Jadwal Latihan Soal',
			'subjudul'=> 'Data Jadwal Latihan Soal',
	...
	public function validasi()
	{
		...
		$jml 	= $this->ujian->getJumlahSoal($matkul_id)->jml_soal;
	...
	public function list_json()
	{
		...
		$list = $this->ujian->getListUjian($this->mhs->id_mahasiswa);
