<a href="<?=base_url('dashboard')?>" class="logo">
    ...
    <span class="logo-lg"><b>B</b>ank <b>S</b>oal <b>FTI</b></span>
</a>
        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu ">
                    ...
                    <!-- Menu Body -->
                    <li class="user-footer text-primary">
                        <div class="pull-left">
                            <a href="<?=base_url()?>users/edit/<?=$user->id?>" class="btn btn-default btn-flat text-primary">
