<div class="box">
    <div class="box-header with-header">
        ...
        <div class="pull-right">
            <a href="<?=base_url()?>sisteminformasi" class="btn btn-xs btn-flat btn-default">
                <i class="fa fa-arrow-left"></i> Kembali
            </a>
            <a href="<?=base_url()?>sisteminformasi/edit/<?=$this->uri->segment(3)?>" class="btn btn-xs btn-flat btn-warning">
    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <?=$soal->soal?>
                <hr class="my-4">
                <h3 class="text-center">Halaman Lainnya</h3>
