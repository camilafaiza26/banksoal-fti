<div class="row">
    <div class="col-sm-12">    
        <?=form_open_multipart('sisteminformasi/save', array('id'=>'formsoal'), array('method'=>'edit', 'id_soal'=>$soal->id_soal));?>
        <div class="box">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <label for="soal" class="control-label text-center">Halaman</label>
                                <div class="row">
                            ...
                            <div class="col-sm-12">
                                <label for="jawaban_<?= $abj; ?>" class="control-label text-center">Halaman <?= $ABJ; ?></label>
                                <div class="row">
                                    <div class="form-group col-sm-3">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group pull-right">
                                    <a href="<?=base_url('sisteminformasi')?>" class="btn btn-flat btn-default"><i class="fa fa-arrow-left"></i> Batal</a>
