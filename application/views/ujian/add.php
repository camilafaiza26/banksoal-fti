        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="nama_ujian">Nama Latihan Soal</label>
                    <input autofocus="autofocus" onfocus="this.select()" placeholder="Nama Latihan Soal" type="text" class="form-control" name="nama_ujian">
