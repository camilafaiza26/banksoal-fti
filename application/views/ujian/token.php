            ...
            <div class="col-sm-6">
                <div class="box box-solid">
                    <div class="box-body pb-0">
                        <div class="callout callout-info">
                            <p>
                                Waktu boleh mengerjakan latihan soal adalah saat tombol "MULAI" berwarna hijau.
                            </p>
                        </div>
                        <?php
                        ...
                        <div class="callout callout-success">
                            <strong><i class="fa fa-clock-o"></i> Latihan soal akan dimulai pada</strong>
                            <br>
                        ...
                        <div class="callout callout-danger">
                            ...
                            Silahkan hubungi admin anda untuk bisa mengikuti latihan soal ini.
                        </div>
                        <?php endif;?>
                    </div>
                </div>
