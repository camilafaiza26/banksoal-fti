<div class="box">
    ...
    <div class="box-body">
        <ul class="alert alert-info" style="padding-left: 40px">
            ...
            <li>Untuk data jurusan, hanya bisa diisi menggunakan ID jurusan. <a data-toggle="modal" href="#kelasId" style="text-decoration:none" class="btn btn-xs btn-primary">Lihat ID</a>.</li>
        </ul>
                            ...
                            <?php
                                ...
                                if (empty($import)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="<?= $data['jurusan_id'] == null ? 'bg-danger' : ''; ?>">
                                            <?= $data['jurusan_id'] == null ? 'BELUM DIISI' : $data['jurusan_id'];; ?>
                                        </td>
                                    </tr>
                            <?php
                                        if ($data['nim'] == null || $data['nama'] == null || $data['email'] == null || $data['jenis_kelamin'] == null || $data['jurusan_id'] == null) {
                                            $status = false;
                                        }
                                    endforeach;
                                }
