...
$(document).ready(function() {
  ...
  table = $("#sisteminformasi").DataTable({
    ...
    serverSide: true,
    ajax: {
      url: base_url + "sisteminformasi/data",
      type: "POST"
    },
    columns: [
      {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        render: function(data, type, row, meta) {
          return `<div class="text-center">
                                <a href="${base_url}sisteminformasi/detail/${data}" class="btn btn-xs btn-default">
                                    <i class="fa fa-eye"></i> Detail
                                </a>
                               
                                <a href="${base_url}sisteminformasi/edit/${data}" class="btn btn-xs btn-warning">
